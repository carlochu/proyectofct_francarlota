        ...
        incidents.forEach(incident => {
            ...
            row.innerHTML = `
                ...
                <td class="actions-container">
                    <button class="view-btn btn-secondary btn-sm" data-id="${incident.incident_id}">View</button>
                    <button class="edit-btn btn-warning btn-sm" data-id="${incident.incident_id}">Edit</button>
                    <button class="delete-btn btn-danger btn-sm" data-id="${incident.incident_id}">Delete</button>
                </td>
            `;
        });
    }
...
// Escucha el clic del botón con id "listIncidentsBtn"
document.getElementById("listIncidentsBtn").addEventListener("click", function() {
    location.reload();  // Esto recargará la página cuando se haga clic en el botón
});
